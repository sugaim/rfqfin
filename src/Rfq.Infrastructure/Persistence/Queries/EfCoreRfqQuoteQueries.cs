...
{
    public async Task<IReadOnlyList<QuoteHistoryItem>> GetAsync(CaseId caseId,
        ...
        await (from quote in dbContext.ConfirmedQuotes.AsNoTracking()
               ...
               select new QuoteHistoryItem(new QuoteId(quote.QuoteId),
                   new RevisionId(quote.RevisionId), quote.Mode, quote.ConfirmedAt,
                   quote.ExpiresAt, quote.RequestReasonAnswered))
