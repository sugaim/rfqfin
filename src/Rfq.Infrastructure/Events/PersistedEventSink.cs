...
public sealed class PersistedEventSink : IQuoteEventSink, IRfqEventSink
{
    ...
    {
        if (!Enum.TryParse<RfqStatus>(value, ignoreCase: false, out RfqStatus status)
...
internal sealed record PendingRfqRevisionConfirmedEvent(
    CaseId CaseId,
    RevisionId? From,
    RevisionId To,
    UserId ActorUserId,
...
internal sealed record PendingRfqPickedUpEvent(
    CaseId CaseId,
    UserId AssignedTraderId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingRfqEvent(CaseId, ActorUserId, OccurredAt);

internal sealed record PendingRfqReleasedEvent(
    CaseId CaseId,
    UserId AssignedTraderId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingRfqEvent(CaseId, ActorUserId, OccurredAt);

internal sealed record PendingRfqAssignedTraderChangedEvent(
    CaseId CaseId,
    UserId From,
    UserId To,
    UserId ActorUserId,
...
internal sealed record PendingRfqTakenOverEvent(
    CaseId CaseId,
    UserId From,
    UserId To,
    UserId ActorUserId,
...
internal sealed record PendingQuoteConfirmedEvent(
    QuoteId QuoteId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingQuoteEvent(QuoteId, ActorUserId, OccurredAt);

internal sealed record PendingQuotePresentedEvent(
    QuoteId QuoteId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingQuoteEvent(QuoteId, ActorUserId, OccurredAt);

internal sealed record PendingQuoteUnpresentedEvent(
    QuoteId QuoteId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingQuoteEvent(QuoteId, ActorUserId, OccurredAt);

internal sealed record PendingQuoteWithdrawnEvent(
    QuoteId QuoteId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingQuoteEvent(QuoteId, ActorUserId, OccurredAt);

internal sealed record PendingQuoteExpiredEvent(
    QuoteId QuoteId,
    UserId ActorUserId,
    DateTimeOffset OccurredAt) : PendingQuoteEvent(QuoteId, ActorUserId, OccurredAt);
