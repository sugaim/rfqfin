...
public static class InitialDraftTransitions
{
        ...
        StateVersion expectedRevisionVersion)
    {
        ...
        RfqRevision revision = rfq.CurrentRevision.UpdateDraft(terms, expectedRevisionVersion);
    ...
    {
        EnsureInitialDraft(rfq);
        RfqRevision revision = rfq.CurrentRevision.Discard(expectedRevisionVersion);
