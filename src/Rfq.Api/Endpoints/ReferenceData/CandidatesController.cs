...
{
    [HttpGet("api/reference-data/assignable-traders")]
    [EndpointName("GetAssignableTraders")]
    ...
    [HttpGet("api/reference-data/contact-owner-candidates")]
    [EndpointName("GetContactOwnerCandidates")]
    ...
    [HttpGet("api/reference-data/clients")]
    [EndpointName("SearchClients")]
    ...
    [HttpGet("api/reference-data/securities")]
    [EndpointName("SearchSecurities")]
